...
namespace TheFarmOfUs {
    ...
    public partial class LOGINUSERDataSet3 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/LOGINUSERDataSet3.xsd";
        ...
        public partial class FuncionarioDataTable : global::System.Data.TypedTableBase<FuncionarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public FuncionarioRow AddFuncionarioRow(string Nome, string CPF, string Data_nascimento, string Setor, double Salario) {
...
namespace TheFarmOfUs.LOGINUSERDataSet3TableAdapters {
    ...
    public partial class FuncionarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Funcionario] WHERE (([Id] = @Original_Id) AND ([Nome] = @Origi" +
                "nal_Nome) AND ([CPF] = @Original_CPF) AND ([Data_nascimento] = @Original_Data_na" +
                "scimento) AND ([Setor] = @Original_Setor) AND ([Salario] = @Original_Salario))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Funcionario] ([Nome], [CPF], [Data_nascimento], [Setor], [Sala" +
                "rio]) VALUES (@Nome, @CPF, @Data_nascimento, @Setor, @Salario);\r\nSELECT Id, Nome" +
                ", CPF, Data_nascimento, Setor, Salario FROM Funcionario WHERE (Id = SCOPE_IDENTI" +
                "TY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Funcionario] SET [Nome] = @Nome, [CPF] = @CPF, [Data_nascimento] = @Data_nascimento, [Setor] = @Setor, [Salario] = @Salario WHERE (([Id] = @Original_Id) AND ([Nome] = @Original_Nome) AND ([CPF] = @Original_CPF) AND ([Data_nascimento] = @Original_Data_nascimento) AND ([Setor] = @Original_Setor) AND ([Salario] = @Original_Salario));
SELECT Id, Nome, CPF, Data_nascimento, Setor, Salario FROM Funcionario WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nome, CPF, Data_nascimento, Setor, Salario FROM dbo.Funcionario";
        ...
        public virtual int Delete(int Original_Id, string Original_Nome, string Original_CPF, string Original_Data_nascimento, string Original_Setor, double Original_Salario) {
        ...
        public virtual int Insert(string Nome, string CPF, string Data_nascimento, string Setor, double Salario) {
            if ((Nome == null)) {
        ...
        public virtual int Update(string Nome, string CPF, string Data_nascimento, string Setor, double Salario, int Original_Id, string Original_Nome, string Original_CPF, string Original_Data_nascimento, string Original_Setor, double Original_Salario, int Id) {
            if ((Nome == null)) {
                throw new global::System.ArgumentNullException("Nome");
            }
            else {
            ...
            if ((Original_Data_nascimento == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_Data_nascimento));
            }
            if ((Original_Setor == null)) {
                throw new global::System.ArgumentNullException("Original_Setor");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((double)(Original_Salario));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string CPF, string Data_nascimento, string Setor, double Salario, int Original_Id, string Original_Nome, string Original_CPF, string Original_Data_nascimento, string Original_Setor, double Original_Salario) {
            return this.Update(Nome, CPF, Data_nascimento, Setor, Salario, Original_Id, Original_Nome, Original_CPF, Original_Data_nascimento, Original_Setor, Original_Salario, Original_Id);
        }
    }
